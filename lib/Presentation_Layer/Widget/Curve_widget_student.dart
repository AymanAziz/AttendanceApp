...
class CurveWidgetStudent extends StatelessWidget {

  final Widget child;
  final double curveDistance;
  final double curveHeight;

  const CurveWidgetStudent({Key? key, required this.child,  this.curveDistance = 70,  this.curveHeight = 70}) : super(key: key);
