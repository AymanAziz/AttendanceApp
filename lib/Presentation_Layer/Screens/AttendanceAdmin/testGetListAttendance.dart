...
class TestGetAttendanceList extends StatefulWidget {
  const TestGetAttendanceList({Key? key}) : super(key: key);

  @override
  State<TestGetAttendanceList> createState() => _TestGetAttendanceListState();
}

class _TestGetAttendanceListState extends State<TestGetAttendanceList> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      body: BlocProvider<UserBloc>(create: (context){ userBloc.add(CountUserFireStore()); return userBloc;},
        child:  BlocListener<UserBloc, UserState>(
            ...
            StreamBuilder<DocumentSnapshot>(
                stream: AttendanceRepository().getAttendanceTest(selectDateDatabase),
                builder: (context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                  if (snapshot.connectionState == ConnectionState.active) {
                    ...
                    if (!snapshot.hasData) {
                      ...
                      attendanceDocument["Student"].length.toString();
